...
const { registerBroadcastCommand } = require('./src/bot/broadcast');
const { registerDashboardCommand } = require('./src/bot/dashboard');
...
if (!process.env.ADMIN_USER_IDS) {
  console.log('تنبيه: ADMIN_USER_IDS غير مضبوط — أمرا /broadcast و /dashboard غير مفعّلين لأي مستخدم.');
}
...
if (!process.env.ADMIN_USER_IDS) {
console.log('تنبيه: ADMIN_USER_IDS غير مضبوط — ميزة البث (/broadcast) غير مفعّلة لأي مستخدم.');
}
